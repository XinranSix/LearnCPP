...
class Bodyanalysis : public AipBase {
  public:
    ...
    Bodyanalysis(const std::string &app_id, const std::string &ak,
                 const std::string &sk)
     ...
     */
    Json::Value body_analysis_v1(std::string const &image) {
        std::map<std::string, std::string> data;
        data["image"] = base64_encode(image.c_str(), (int)image.size());
        Json::Value result = this->request(_body_analysis_v1, null, data, null);
     ...
     */
    Json::Value
    body_attr_v1(std::string const &image,
                 const std::map<std::string, std::string> &options) {
        std::map<std::string, std::string> data;
        data["image"] = base64_encode(image.c_str(), (int)image.size());
        std::copy(options.begin(), options.end(),
                  std::inserter(data, data.end()));
        Json::Value result = this->request(_body_attr_v1, null, data, null);
     ...
     */
    Json::Value body_num_v1(std::string const &image,
                            const std::map<std::string, std::string> &options) {
        std::map<std::string, std::string> data;
        data["image"] = base64_encode(image.c_str(), (int)image.size());
        std::copy(options.begin(), options.end(),
                  std::inserter(data, data.end()));
        Json::Value result = this->request(_body_num_v1, null, data, null);
     ...
     */
    Json::Value
    driver_behavior_v1(std::string const &image,
                       const std::map<std::string, std::string> &options) {
        std::map<std::string, std::string> data;
        data["image"] = base64_encode(image.c_str(), (int)image.size());
        std::copy(options.begin(), options.end(),
     ...
     */
    Json::Value body_seg_v1(std::string const &image,
                            const std::map<std::string, std::string> &options) {
        std::map<std::string, std::string> data;
        data["image"] = base64_encode(image.c_str(), (int)image.size());
        std::copy(options.begin(), options.end(),
                  std::inserter(data, data.end()));
        Json::Value result = this->request(_body_seg_v1, null, data, null);
     ...
     */
    Json::Value gesture_v1(std::string const &image) {
        std::map<std::string, std::string> data;
        data["image"] = base64_encode(image.c_str(), (int)image.size());
        Json::Value result = this->request(_gesture_v1, null, data, null);
     ...
     */
    Json::Value body_tracking_v1(std::string const &dynamic,
        ...
        Json::Value result =
            this->request_com(_body_tracking_v1, data, &headers);
    ...
    Json::Value hand_analysis_v1(std::string const &image) {
        std::map<std::string, std::string> data;
        data["image"] = base64_encode(image.c_str(), (int)image.size());
        Json::Value result = this->request(_hand_analysis_v1, null, data, null);
     ...
     */
    Json::Value body_danger_v1(std::string const &video_data) {
        std::map<std::string, std::string> data;
        data["data"] =
            base64_encode(video_data.c_str(), (int)video_data.size());
        Json::Value result = this->request(_body_danger_v1, null, data, null);
     ...
     */
    Json::Value fingertip_v1(std::string const &image) {
        std::map<std::string, std::string> data;
        data["image"] = base64_encode(image.c_str(), (int)image.size());
        Json::Value result = this->request(_fingertip_v1, null, data, null);
