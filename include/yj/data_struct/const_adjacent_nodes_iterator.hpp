...
#ifndef YT_CONST_ADJACENT_NODES_ITERATOR
#define YT_CONST_ADJACENT_NODES_ITERATOR
...
namespace yt {
    ...
    template <typename GraphType>
    const_adjacent_nodes_iterator<GraphType>::const_adjacent_nodes_iterator(iterator_type it,
    ...
    bool const_adjacent_nodes_iterator<GraphType>::operator==(
        ...
        return (m_graph == rhs.m_graph && m_adjacentNodeIterator == rhs.m_adjacentNodeIterator);
    }
