...
#ifndef YT_ADJACENT_NODES_ITERATOR
#define YT_ADJACENT_NODES_ITERATOR
...
namespace yt {
    ...
    template <typename GraphType>
    adjacent_nodes_iterator<GraphType>::adjacent_nodes_iterator(iterator_type it,
    ...
    template <typename GraphType>
    adjacent_nodes_iterator<GraphType> &adjacent_nodes_iterator<GraphType>::operator++() {
        this->increment();
        return *this;
    }
    ...
    // Defer the details to the increment() helper.
    template <typename GraphType>
    adjacent_nodes_iterator<GraphType> adjacent_nodes_iterator<GraphType>::operator++(int) {
        auto oldIt { *this };
        this->increment();
        return oldIt;
    }
